			...
			<a href="<?php echo get_author_posts_url( $user->id );?>">
				<div class="card">
					...
					<div class="faculty-details">
						...
						<h3><?php echo get_user_meta( $user->id, 'faculty_position' )[0];?></h3>
						<h3><?php echo get_user_meta( $user->id, 'faculty_qual' )[0];?></h3>
						<h3><?php echo get_user_meta( $user->id, 'faculty_exp' )[0];?> Years Experience </h3>
						<h3><?php echo get_user_meta( $user->id, 'faculty_specialization' )[0];?></h3>
					</div>
				</div>
			</a>
			<?php
