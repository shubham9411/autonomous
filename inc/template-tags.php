...
function anomous_new_checkbox() {
	...
	<div class="misc-pub-section misc-pub-section-last">
		<label><input type="checkbox" value="1" <?php checked( $value, true, true ); ?> name="anomous_new_checkbox" /><?php esc_html_e( 'Add \'New\' Label', 'autonomous' ); ?></label>
	</div>
	<?php
}
 ...
 *
 * @param int $post_id Id of the particular Post.
 */
